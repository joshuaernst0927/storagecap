...

{
  ...
  "currentAvgRentPerUnit": number (CURRENT average monthly rent per unit in dollars — what tenants are ACTUALLY paying today, from the rent roll or T12 revenue divided by occupied units) or null,
  "marketAvgRentPerUnit": number (MARKET RATE average monthly rent per unit — what the market SUPPORTS, from competitor rents, market comparables, or market rate tables in the OM. This should be HIGHER than currentAvgRentPerUnit for value-add deals. Do NOT use the same number as currentAvgRentPerUnit) or null,
