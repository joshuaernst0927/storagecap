...
export default function Home() {
  return (
    <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              <div className="flex items-center gap-3 mb-8">
                ...
                <span className="font-sans text-xs uppercase tracking-[0.18em]" style={{ color: '#D4A843' }}>
              ...
              >
                Self-Storage.<br />
                Off-Market.<br />
                <em style={{ color: '#D4A843' }}>Systematically.</em>
              </h1>
              <p className="leading-relaxed mb-10" style={{ color: 'rgba(255,255,255,0.75)', fontSize: '1.05rem', maxWidth: '480px' }}>
            ...
            {/* Stats panel */}
            <div style={{ background: 'rgba(255,255,255,0.07)', border: '1px solid rgba(255,255,255,0.15)', padding: '2rem' }}>
              {stats.map((s, i) => (
                <div key={s.label} style={{ padding: '1.25rem 0', borderBottom: i < stats.length - 1 ? '1px solid rgba(255,255,255,0.12)' : 'none' }}>
                  <div className="font-serif" style={{ fontSize: '3rem', color: '#D4A843', lineHeight: '1', fontWeight: 500 }}>
                    {s.value}
                  </div>
                  <div className="font-sans uppercase tracking-widest" style={{ fontSize: '0.7rem', color: 'rgba(255,255,255,0.5)', marginTop: '0.25rem' }}>
                    {s.label}
                  </div>
                </div>
              ))}
      ...
      <section style={{ backgroundColor: '#FFFFFF', borderBottom: '1px solid #E0DDD4' }}>
        <div className="mx-auto px-6 lg:px-12 py-20" style={{ maxWidth: '1100px' }}>
          <div className="flex items-center gap-3 mb-3">
            <div className="w-8 h-px" style={{ backgroundColor: '#D4A843' }} />
            <span className="font-sans text-xs uppercase tracking-[0.18em]" style={{ color: '#D4A843' }}>Our Process</span>
          </div>
          <h2 className="font-serif font-light mb-14" style={{ fontSize: 'clamp(2rem, 4vw, 3rem)', color: '#1B2B5E', lineHeight: '1.1' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: '1px', background: '#E0DDD4' }}>
            {process.map((p) => (
              <div key={p.num} style={{ background: '#FFFFFF', padding: '1.75rem 1.5rem' }}>
                <div className="font-serif" style={{ fontSize: '3.5rem', color: '#E0DDD4', lineHeight: '1', marginBottom: '1rem', fontWeight: 400 }}>
                  {p.num}
                </div>
                <div className="font-sans uppercase tracking-widest" style={{ fontSize: '0.7rem', color: '#D4A843', fontWeight: 500, marginBottom: '0.5rem', letterSpacing: '0.1em' }}>
                  {p.title}
                </div>
                <p style={{ fontSize: '0.82rem', color: '#6B6860', lineHeight: '1.65' }}>{p.body}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* ── Distress Scoring ── light gray bg */}
        ...
        <div className="mx-auto px-6 lg:px-12 py-20" style={{ maxWidth: '1100px' }}>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            <div>
              <div className="flex items-center gap-3 mb-3">
                <div className="w-8 h-px" style={{ backgroundColor: '#D4A843' }} />
                <span className="font-sans text-xs uppercase tracking-[0.18em]" style={{ color: '#D4A843' }}>Distress Intelligence</span>
              </div>
              ...
              <p style={{ fontSize: '0.95rem', color: '#6B6860', lineHeight: '1.75', marginBottom: '2rem' }}>
              ...
              <div style={{ marginBottom: '2rem' }}>
                <div className="flex justify-between font-sans uppercase" style={{ fontSize: '0.7rem', letterSpacing: '0.1em', color: '#6B6860', marginBottom: '0.5rem' }}>
                  <span>Low Intent</span><span>High Intent</span>
                </div>
                <div style={{ height: '3px', background: '#E0DDD4' }}>
                  <div style={{ height: '3px', width: '72%', background: '#D4A843' }} />
                </div>
                <div style={{ fontSize: '0.75rem', color: '#6B6860', marginTop: '0.5rem' }}>Avg Pipeline Score: 72 / 100</div>
              </div>
            ...
            <div style={{ background: '#FFFFFF', border: '1px solid #E0DDD4', padding: '0 1.5rem' }}>
              {scoreFactors.map((f, i) => (
                <div key={f.name} style={{
                  ...
                  padding: '1.1rem 0', borderBottom: i < scoreFactors.length - 1 ? '1px solid #E0DDD4' : 'none', gap: '1rem',
                }}>
                  <div>
                    <div style={{ fontSize: '0.9rem', color: '#1A1A18', marginBottom: '0.2rem', fontWeight: 500 }}>{f.name}</div>
                    <div style={{ fontSize: '0.75rem', color: '#6B6860' }}>{f.desc}</div>
                  </div>
                  <div className="font-serif" style={{ fontSize: '1.3rem', color: '#D4A843', whiteSpace: 'nowrap', fontWeight: 500 }}>{f.pts}</div>
                </div>
              ))}
            </div>
      ...
      <section style={{ backgroundColor: '#FFFFFF', borderBottom: '1px solid #E0DDD4' }}>
        <div className="mx-auto px-6 lg:px-12 py-20" style={{ maxWidth: '1100px' }}>
          <div className="flex items-center gap-3 mb-3">
            <div className="w-8 h-px" style={{ backgroundColor: '#D4A843' }} />
            <span className="font-sans text-xs uppercase tracking-[0.18em]" style={{ color: '#D4A843' }}>Target Markets</span>
          </div>
          <h2 className="font-serif font-light mb-12" style={{ fontSize: 'clamp(2rem, 4vw, 3rem)', color: '#1B2B5E', lineHeight: '1.1' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '1px', background: '#E0DDD4' }}>
            {markets.map((m) => (
              <div key={m.state} style={{ background: '#FFFFFF', padding: '1.5rem' }}>
                <div className="font-serif" style={{ fontSize: '2.5rem', color: '#1B2B5E', lineHeight: '1', marginBottom: '0.5rem', fontWeight: 500 }}>
                  {m.state}
                </div>
                <div style={{ fontSize: '0.78rem', color: '#6B6860', lineHeight: '1.7' }}>{m.cities}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section style={{ backgroundColor: '#1B2B5E' }}>
        <div className="mx-auto px-6 lg:px-12 py-20" style={{ maxWidth: '1100px' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1px', background: 'rgba(255,255,255,0.15)' }}>
            ...
            <div style={{ background: '#1B2B5E', padding: '2.5rem', border: '1px solid rgba(255,255,255,0.12)' }}>
              <div className="font-sans uppercase tracking-widest" style={{ fontSize: '0.7rem', color: 'rgba(255,255,255,0.45)', marginBottom: '1rem', letterSpacing: '0.15em' }}>For Sellers</div>
              <h3 className="font-serif font-light mb-3" style={{ fontSize: '1.8rem', color: '#FFFFFF' }}>Selling your facility?</h3>
              <p style={{ fontSize: '0.9rem', color: 'rgba(255,255,255,0.65)', lineHeight: '1.75', marginBottom: '2rem' }}>
            ...
            <div style={{ background: '#1B2B5E', padding: '2.5rem', border: '1px solid rgba(255,255,255,0.12)', borderLeft: 'none' }}>
              <div className="font-sans uppercase tracking-widest" style={{ fontSize: '0.7rem', color: 'rgba(255,255,255,0.45)', marginBottom: '1rem', letterSpacing: '0.15em' }}>For Investors</div>
              <h3 className="font-serif font-light mb-3" style={{ fontSize: '1.8rem', color: '#FFFFFF' }}>Investing in storage?</h3>
              <p style={{ fontSize: '0.9rem', color: 'rgba(255,255,255,0.65)', lineHeight: '1.75', marginBottom: '2rem' }}>
